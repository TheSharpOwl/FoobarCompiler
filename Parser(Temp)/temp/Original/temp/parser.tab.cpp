...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VAR = 3,                        /* VAR  */
  YYSYMBOL_COL = 4,                        /* COL  */
  YYSYMBOL_ITYPE = 5,                      /* ITYPE  */
  YYSYMBOL_IDENTIFIER = 6,                 /* IDENTIFIER  */
  YYSYMBOL_INTEGER = 7,                    /* INTEGER  */
  YYSYMBOL_EOL = 8,                        /* EOL  */
  YYSYMBOL_YYACCEPT = 9,                   /* $accept  */
  YYSYMBOL_program = 10,                   /* program  */
  YYSYMBOL_SimpleDeclaration = 11,         /* SimpleDeclaration  */
  YYSYMBOL_VariableDeclaration = 12,       /* VariableDeclaration  */
  YYSYMBOL_type = 13,                      /* type  */
  YYSYMBOL_PrimitiveType = 14              /* PrimitiveType  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VAR", "COL", "ITYPE",
  "IDENTIFIER", "INTEGER", "EOL", "$accept", "program",
  "SimpleDeclaration", "VariableDeclaration", "type", "PrimitiveType", YY_NULLPTR
};
